...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference("Artwork.count") do
      post artworks_url, params: { artwork: { category: @artwork.category, description: @artwork.description, price: @artwork.price, size: @artwork.size, title: @artwork.title } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { category: @artwork.category, description: @artwork.description, price: @artwork.price, size: @artwork.size, title: @artwork.title } }
